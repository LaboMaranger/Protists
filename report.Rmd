...
#import traits
traits=read.csv("data/TransectTraitsTable_wide_10_2021.csv")
...
plot_transect(com_prop[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_fs),"DSP.4"],legend=F,f=0.6,ylim=c(0,0.9))
...
```{r feedStrat micro, echo=F,fig.keep="none",results="hide"}
library(vegan)
...
fsVector=traitsByOTU(transect_micro_agg,traits,"feeding_strategy",cw_micro,"validName")
...
plot_transect(com_prop[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_fs),"DSP.4"],legend=F,f=0.6,ylim=c(0,1))
#plot_transect(com_prop[,c(2,3,1)],samdf_agg[rownames(transect_fs),"DSB.4"])
invisible(dev.off())
...
plot_transect_small(prop_fs_C1[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_sizeClass),"DSP.4"])
dev.off()

ppi=600
png("figures/prop_fs_C2.png",width =8, height = 4.8, units = 'in',bg="transparent",res=ppi)
plot_transect_small(prop_fs_C2[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_sizeClass),"DSP.4"])
dev.off()
ppi=600
png("figures/prop_fs_C3.png",width =8, height = 4.8, units = 'in',bg="transparent",res=ppi)
plot_transect_small(prop_fs_C3[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_sizeClass),"DSP.4"])
dev.off()

ppi=600
png("figures/prop_fs_C4.png",width =8, height = 4.8, units = 'in',bg="transparent",res=ppi)
plot_transect_small(prop_fs_C4[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_sizeClass),"DSP.4"])
dev.off()

ppi=600
png("figures/prop_fs_C5.png",width =8, height = 4.8, units = 'in',bg="transparent",res=ppi)
plot_transect_small(prop_fs_C5[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_sizeClass),"DSP.4"])
dev.off()

plot_transect_small(fs_C5[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_sizeClass),"DSP.4"])
plot_transect_small(fs_C4[,c("mixo","hetero","auto")],samdf_agg[rownames(transect_sizeClass),"DSP.4"])
