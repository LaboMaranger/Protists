...
vp=varpart(com,dat$DSP.4,cbind(dat$stationGrcentre,dat$stationGrgreenland),cbind(dat$Year2015,dat$Year2016))
plot(vp)
...
samdf_agg[rownames(transect_seq_agg),]),permutations = 9999)
...
vp=varpart(com,dat$DSP.4,cbind(dat$stationGrcentre,dat$stationGrgreenland),dat$Year)
